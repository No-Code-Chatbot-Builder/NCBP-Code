...
export const setEnvironmentVariables = () => {
  try {
    ...
    const requiredKeys = ['PINECONE_API_KEY', 'DYNAMODB_TABLE_NAME', 'S3_BUCKET_NAME', 'PINECONE_INDEX_NAME', 'USER_POOL_ID', 'CLIENT_ID', 'AWS_ACCESS_KEY_ID', 'AWS_SECRET_ACCESS_KEY', 'AWS_DEFAULT_REGION'];
